...
c.execute(
    "CREATE TABLE IF NOT EXISTS users(id INTEGER PRIMARY KEY, \
        username text, email text, phone text, website text, regdate text)")  # AUTOINCREMENT

# # 데이터 삽입
c.execute("INSERT INTO users VALUES (1 ,'Kim',\
    'Kim@naver.com', '010-0000-0000', 'Kim.com', ?)", (nowDatetime,))
...
# # 테이블 데이터 삭제
# conn.execute("DELETE FROM use rs")
